...
<script>
import MiniStatisticsCard from "@/pantallas/Cards/MiniStatisticsCard.vue";
import ReportsBarChart from "@/pantallas/Charts/ReportsBarChart";
import GradientLineChart from "@/pantallas/Charts/GradientLineChart.vue";
