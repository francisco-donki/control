...
<script>
import Sidenav from "@/pantallas/Sidenav";
import AppFooter from "@/pantallas/Footer.vue";
import Navbar from "@/pantallas/Nav/Navbar.vue";
import CalendarCard from "./components/CalendarCard.vue";
import EmailCard from "./components/EmailCard.vue";
import TodoCard from "./components/TodoCard.vue";
//import MiniPlayerCard from "@/pantallas/Cards/MiniPlayerCard.vue";
